...
class FFAIRModel(nn.Module):
    ...
    def forward(self, images, targets=None, mode='train'):
        att_feats = 0
        fc_feats = 0
        # print("images shape", images.shape) # [1, 169, 3, 224, 224]
        ...
        # print("att_feats.shape",att_feats.shape) # att_feats.shape torch.Size([1, 49, 2048])     
        # print("fc_feats.shape", fc_feats.shape) # fc_feats.shape torch.Size([1, 2048])
        if mode == 'train':
