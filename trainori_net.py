...
def parse_args():
  ...
  # Data input settings
  parser.add_argument('--image_dir', type=str, default='/jizhicfs/jhsun/data/FFAIRNew/FFA-IR_image/EYE/', help='the path to the images.')
  parser.add_argument('--ann_path', type=str, default='/jizhicfs/jhsun/data/FFAIRNew/updated_ffair_annotation.csv', help='the path to the annotation file.')
  parser.add_argument('--box_ann_path', type=str, default='/jizhicfs/jhsun/data/FFAIRNew/lesion_info_new.json', help='the path to the bbox annotation file.')
  ...
  parser.add_argument('--save_dir', dest='save_dir',
                      help='directory to save models', default="/jizhicfs/jhsun/DPIF-FFAIR-main-output/models",
                      type=str)
...
if __name__ == '__main__':
  ...
  dataset = FFAIRDataset(args, tokenizer, 'train')
  ...
  for epoch in range(args.start_epoch, args.max_epochs + 1):
    ...
    for data in dataloader:
      ...
      # print("data", im_data.shape) # [1, 37, 3, 224, 224]
      # print(gt_boxes)
      # print("box", gt_boxes.shape) # [ 1, 37, 1, 5]
      # print(len(gt_boxes[3]))
